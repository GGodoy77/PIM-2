# view/Login/page_team_login.py

from customtkinter import *
import view.Login.page_login as tela_login
import view.Account_Pages.page_team_mainpage as tela_time
from tkinter import messagebox
import json
import os
import service.security as security

class TeamLogin(CTkFrame):
    ...
    def conta_time(self, dados_usuario):
        self.destroy()
        tela_time.TeamMainpage(self.master, dados_usuario).pack(fill='both', expand=True)
    ...
    def validar(self):
        ...
        if os.path.exists("teams.json"):
            ...
            for team_id, info in self.dados.items(): 
                try:
            ...
            messagebox.showerror("Erro", "Arquivo de dados de times não encontrado.")